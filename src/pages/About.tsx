  ...
  const team = [
    {
      ...
      description: 'Leading Nikit Hardware with 15+ years in construction materials industry.',
      image: '/placeholder-avatar.jpg',
    },
    {
      name: 'Michael Chen',
      role: 'Head of Operations',
      description: 'Ensuring seamless supply chain and quality control across all operations.',
      image: '/placeholder-avatar.jpg',
    },
    {
        ...
        <FadeInSection>
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              Founded in 1995, Nikit Hardware began as a small family business with a simple mission: 
        ...
        <FadeInSection delay={800}>
          <div className="bg-secondary rounded-2xl p-8 lg:p-12 mt-16">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold mb-4">Why Choose Nikit Hardware?</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
