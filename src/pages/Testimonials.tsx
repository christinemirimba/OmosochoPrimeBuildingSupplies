...
const testimonials = [
    ...
    },
    {
        ...
        rating: 5,
        content: 'The customer service at Omosocho Prime is exceptional. They helped us find the perfect materials for our commercial project and provided technical support throughout. Highly recommended!',
        image: '/placeholder-avatar.jpg',
    },
    {
        id: 3,
    ...
    },
    {
        ...
        rating: 5,
        content: 'Their steel products are top-notch, and the safety equipment keeps our workers protected. Omosocho Prime is a trusted partner in our success.',
        image: '/placeholder-avatar.jpg',
    },
    {
        id: 6,
        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="bg-hero py-20 relative">
                <div className="container mx-auto px-4">
                    {/* Exit Button - Close type for Testimonials page */}
                    ...
                    <FadeInSection>
                        <div className="text-center text-white max-w-3xl mx-auto">
                            ...
                            <p className="text-xl text-white/90">
                                ...
                                across the region say about working with Omosocho Prime.
                            </p>
                        </div>
                    </FadeInSection>
                </div>
                            ...
                            <div className="flex gap-2">
                                {Array.from({ length: totalPages }, (_, i) => (
                                    <button
                                        ...
                                        className={`w-3 h-3 rounded-full transition-colors ${i === currentIndex ? 'bg-primary' : 'bg-muted'
                                            }`}
                                    />
                                ))}
                            </div>
                ...
                <FadeInSection delay={600}>
                    <div className="bg-secondary rounded-2xl p-8 lg:p-12 text-center">
                        ...
                        <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                            Join thousands of satisfied customers who trust Omosocho Prime for their construction needs.
